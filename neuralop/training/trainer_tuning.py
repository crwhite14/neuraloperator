...
class TunedTrainer:
    ...
    def train(self, train_loader, test_loaders, output_encoder,
        ...
        if self.use_distributed:
            ...
            is_logger = True 
        last_five_losses = deque([], maxlen=5)
        for epoch in range(self.n_epochs):
            assert(self.n_epochs > 5, 'Minimum budget(n_epochs) must be greater than 5.')
            avg_loss = 0
            avg_lasso_loss = 0
            model.train()
            t1 = default_timer()
            ...
            if epoch % self.log_test_interval == 0: 
                ...
                for loader_name, loader in test_loaders.items():
                    ...
                    last_five_losses.append(errors)
