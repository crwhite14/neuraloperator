...
python train_navier_stokes.py --wandb.name=NS-10k-amp+half
...
python train_navier_stokes.py --wandb.name=NS-10k-half-mode32 --tfno2d.n_modes_height=32 --tfno2d.n_modes_width=32 --tfno2d.half_prec_fourier=True --opt.amp_autocast=True

#half-preciion with n_modes_height = 16
python train_navier_stokes.py --wandb.name=NS-10k-half-mode16 --tfno2d.n_modes_height=16 --tfno2d.n_modes_width=16 --tfno2d.half_prec_fourier=True --opt.amp_autocast=True
