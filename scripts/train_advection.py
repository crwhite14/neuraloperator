...
if config.wandb.log and is_logger:
    if config.wandb.name:
        ...
        wandb_name = '_'.join(
            f'{var}' for var in [config_name, config.tfno1d.n_layers, 
                                 config.tfno1d.hidden_channels, 
                                 config.tfno1d.n_modes_width,
                                 config.tfno1d.n_modes_height,
                                 config.tfno1d.factorization,
                                 config.tfno1d.rank, 
